...
Принцип роботи в новому класі String: об'єкти типу String можна додавати як між собою, так і з будь-яким іншим типом,
 який може бути приведений до типу рядка. "Під капотом",
...
Принцип віднімання в новому класі String: з об'єкту типу String ви можете відняти значення будь-якого іншого типу,
 яке можна привести до типу рядка. "Під капотом", обидва операнди приводяться до типу str,
  а потім з першого операнду видаляється перше входження значення другоо операнду, якщо такий має місце.
   Результатом віднімання стане новий об'єкт класу String. Якщо в першому операнді немає значення другого операнду,
    то результатом віднімання стане перший операнд без змін. Приклади виконання:
...
class String(str):
    ...
    def __sub__(self, other):
        return String(super().replace(str(other), '', 1))
...
result7 = String('New') + None
print(result7)

result8 = String('New bala7nce') - 7
print(result8)

result9 = String('New balance') - 'bal'
print(result9)

result10 = String('New balance') - 'Bal'
print(result10)

result11 = String('pineapple apple pine') - 'apple'
print(result11)

result12 = String('New balance') - 'apple'
print(result12)

result13 = String('NoneType') - None
print(result13)

result14 = String(55678345672) - 7
print(result14)